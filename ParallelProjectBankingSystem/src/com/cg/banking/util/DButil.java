...
public class DButil {
	...
	static {
		bankCredentialsDBMap.put("162207", "aa123");
		bankDBMap.put("162207",new Customer("162207", "Jyotiradity Singh", LocalDate.of(1996,Month.MAY, 24), "Saving", 15500.0F, 200000.0));
		bankCredentialsDBMap.put("160662", "di123");
		bankDBMap.put("160662", new Customer("160662", "Aditya Singh",LocalDate.of(2018, Month.SEPTEMBER, 26), "Current", 15500.0F,200000.0));
		bankCredentialsDBMap.put("160601", "ab123");
		bankDBMap.put("160601", new Customer("160601", "Aditi Singh",LocalDate.of(2018, Month.SEPTEMBER, 14), "Saving", 15500.0F,200000.0));
		bankCredentialsDBMap.put("160608", "ra123");
		bankDBMap.put("160608",new Customer("160608", "Arjun Singh", LocalDate.of(2017,Month.DECEMBER, 15), "Current", 15500.0F, 200000.0));
	}
